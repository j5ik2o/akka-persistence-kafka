...
class SnapshotAkkaSerializerSpec
    extends TestKit(
      ActorSystem(
        ...
        ConfigFactory.parseString(
          ...
          |  actor {
          |    serializers {
          |      kafka-journal = "com.github.j5ik2o.akka.persistence.kafka.serialization.SnapshotAkkaSerializer"
          |    }
          |    serialization-bindings {
          |      "com.github.j5ik2o.akka.persistence.kafka.snapshot.KafkaSnapshot" = kafka-journal
          |    }
          |  }
          |}
          |""".stripMargin
  ...
  "SnapshotAkkaSerializerSpec" - {
    "serialization" in {
      ...
      val reversed   = serialization.deserialize(binary, classOf[KafkaSnapshot]).get
